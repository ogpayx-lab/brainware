...
export type ProductCategory = 'flowers' | 'hashish' | 'oils' | 'edibles' | 'accessories' | 'cosmetics' | 'clothes' | 'seeds' | 'vape' | 'food'
export type AcquisitionChannel = 'walk-in' | 'social' | 'google' | 'referral' | 'shopify' | 'other'
